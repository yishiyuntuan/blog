...
func newQuestion(db *gorm.DB, opts ...gen.DOOption) question {
	...
	_question.Name = field.NewString(tableName, "name")
	_question.Qq = field.NewString(tableName, "qq")
	_question.Email = field.NewString(tableName, "email")
	_question.Question = field.NewString(tableName, "question")
	_question.Reply = field.NewString(tableName, "reply")
	_question.Like = field.NewInt64(tableName, "like")
	_question.Check = field.NewBool(tableName, "check")
	_question.Show = field.NewBool(tableName, "show")
...
func (q *question) updateTableName(table string) *question {
	...
	q.Like = field.NewInt64(table, "like")
	q.Check = field.NewBool(table, "check")
	q.Show = field.NewBool(table, "show")
...
func (q *question) fillFieldMap() {
	...
	q.fieldMap["like"] = q.Like
	q.fieldMap["check"] = q.Check
	q.fieldMap["show"] = q.Show
}
